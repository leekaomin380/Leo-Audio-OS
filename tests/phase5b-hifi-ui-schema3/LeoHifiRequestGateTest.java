...
public final class LeoHifiRequestGateTest {
    ...
    private static final String BASE="schema=3;session=123;gen=5;supported=1;requested=hifi;effective=hifi_active;live=1;flow=1;vol_ctl_l=213;vol_ctl_r=213;vol_user=0;backend=S24_LE/KHZ_48;fail=0";
    ...
    public static void main(String[] args) {
        ...
        ok(volume.parameter().equals("leo_hifi_volume=0;leo_hifi_session=123;leo_hifi_gen=5"));
        ...
        ok(!volume.accepts(0,state(BASE.replace("gen=5","gen=6")),1001));
        ...
        ok(on.parameter().equals("leo_hifi_mode=true;leo_hifi_session=123;leo_hifi_gen=5"));
        ...
        ok(off.parameter().equals("leo_hifi_mode=false;leo_hifi_session=123;leo_hifi_gen=5"));
