...
cp "$SRC/hal/msm8974/leo_hifi.c" "$SRC/hal/msm8974/leo_hifi.h" "$TMP/"
...
$CC -std=c99 -Wall -Wextra -Wno-unused-parameter -Wshadow -Wsign-compare \
    ...
    -DLEO_ESS_SYSFS_DRIVER='"/tmp/leo-ess-mock/driver"' -o "$TMP/leo_hifi.o" || exit 1
...
$CC -std=gnu99 -Wall -Wextra -Wno-unused-parameter -I "$TMP/include" -I "$TMP" \
    -DLEO_ESS_SYSFS_DRIVER='"/tmp/leo-ess-mock/driver"' \
