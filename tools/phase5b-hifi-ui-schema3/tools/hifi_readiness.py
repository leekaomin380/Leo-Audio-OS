...
def main():
    ...
    exit_code = process_evidence(evidence, evidence_dir)
    ...
    try:
        with open(args.output, "x") as f:
            ...
            json.dump({"exit_code": exit_code,
                       ...
                       "gate_checks": {gate: check_gate(evidence, gate, evidence_dir, scope)
                           for gate in ("host_diagnostic", "target_build", "device_window")},
